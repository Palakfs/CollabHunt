...
const YourTeamCard: React.FC<YourTeamCardProps> = ({ team_name, team_admin_id, team_description,max_members,team, admin_expertise , expectations , commitment_role_id}) => {
  const navigate = useNavigate();
    
    const handleCardClick = () => {
      navigate("/manage_team", { state: { team_id:team , team_name , team_description , max_members , team_admin_id , expectations , admin_expertise , commitment_role_id } });
    };
  return (
    <div 
